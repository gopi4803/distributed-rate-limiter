...
Write-Host ""
Write-Host "===================================================="
Write-Host "Single Node Benchmark Suite"
Write-Host "===================================================="
Write-Host ""
...
#
# Reconfigure for Infrastructure Benchmark
#

Write-Host ""
Write-Host "Reconfiguring deployment for Infrastructure Benchmark..."
Write-Host ""
...
python (Get-GraphScript) "single-node"
